...
export default class GanttChartResource extends LightningElement {
  ...
  handleDragEnd(event) {
    ...
    console.log('this.dragInfo.projectIndex '+this.dragInfo.projectIndex);
    const allocationIndex = this.dragInfo.allocationIndex;
    console.log('this.dragInfo.allocationIndex '+ this.dragInfo.allocationIndex);
    const allocation = this.dragInfo.newAllocation;
    console.log('this.dragInfo.newAllocation '+this.dragInfo.newAllocation);
  ...
  handleDragEnter(event) {
    const projectIndex = this.dragInfo.projectIndex;
    console.log('this.dragInfo.project '+this.dragInfo.projectIndex);
    const allocationIndex = this.dragInfo.allocationIndex;
    ...
    console.log('this.dragInfo',this.dragInfo);
    console.log('index',index);

    if (isNaN(this.dragInfo.startIndex)) {
      this.dragInfo.startIndex = index;
    }
    console.log('this.dragInfo.startIndex',this.dragInfo.startIndex);
