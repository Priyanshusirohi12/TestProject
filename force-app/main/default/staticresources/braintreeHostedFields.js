 ...
 * @property {string} [maskInput.character=â€¢] The character to use when masking the input. The default character ('â€¢') uses a unicode symbol, so the webpage must support UTF-8 characters when using the default.
